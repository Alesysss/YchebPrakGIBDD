...
{
    /// <summary>
    /// Логика взаимодействия для CvetWindow.xaml
    /// </summary>
    public partial class CvetWindow : Window
    {
        public CvetWindow()
        {
            InitializeComponent();
        ...
        {
            MessageBox.Show("Вы перешли на окно 'Цвет машины'");
        }
        public void PopulateCvet()
        {
            using (GIBDDEntities db = new GIBDDEntities())
            {
                var cvet = db.Cvet_Mashini.ToList();
                CvetDG.ItemsSource = cvet;
            }
        }
